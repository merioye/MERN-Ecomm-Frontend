...
const ProductListItem = ({ product }) => {
    const [showFeaturedSwitchLoader, setShowFeaturedSwitchLoader] =
        useState(false);
    ...
    const handleFeaturedSwitchChange = () => {
        ...
        dispatch(
            updateProduct(updatedValues, product, setShowFeaturedSwitchLoader)
        );
    };
    ...
    const handleSaleSwitchChange = () => {
        ...
        dispatch(
            updateProduct(updatedValues, product, setShowSaleSwitchLoader)
        );
    };
    ...
    const handleDelete = () => {
        ...
        dispatch(
            deleteProduct(product._id, setShowDeleteLoader, pageCount, router)
        );
    };
    ...
    return (
        <TableRow sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
            ...
            <TableCell align="center" sx={theme.adminTableCellText}>
                {product.isOnSale ? (
                    <Currency quantity={product.salePrice} currency="usd" />
                ) : (
                    <Currency quantity={product.regularPrice} currency="usd" />
                )}
            </TableCell>
            <TableCell align="center">
            ...
            <TableCell align="center">
                {showSaleSwitchLoader ? (
                    ...
                    <Switch
                        ...
                        onChange={handleSaleSwitchChange}
                    />
                )}
            </TableCell>
            <TableCell align="center" width="100px">
                <Stack direction="row">
                    <IconButton
                        ...
                        onClick={() =>
                            router.push(
                                `/admin/products/${product._id}?page=${
