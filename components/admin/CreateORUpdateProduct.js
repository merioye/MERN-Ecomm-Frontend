    ...
    const handleFormSubmit = (e) => {
        ...
        if (id) {
            if (
                ...
                values.regularPrice === data.regularPrice &&
                values.salePrice === data.salePrice &&
            ...
            if (!selectedImages.length) {
                dispatch(
                    showErrorAlert("Please select atleast one Product Image")
                );
                return;
            }
