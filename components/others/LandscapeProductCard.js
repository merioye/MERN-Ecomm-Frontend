...
import { useTheme, Grid, Box, Checkbox, Typography, Rating, Button } from "@mui/material";
            ...
            <a>
                ...
                >
                    ...
                    <Grid item sx={{ width: 'calc(100% - 200px)'}}>
                        ...
                        <Rating value={product.reviews.length ? memoizedAverageRating : null} readOnly/>
                        ...
                        >
                            <Grid item>
                                <Typography variant='body1' sx={style.discountedPrice}>${product.isOnSale ? product.salePrice : product.regularPrice}.00</Typography>
                            </Grid>
                            {
                                product.isOnSale
                                &&
                                <Grid item>
                                    <Typography variant='body1' sx={style.originalPrice}>${product.regularPrice}.00</Typography>
                                </Grid>
                            }
                        </Grid>

                        {
                            ...
                            <Button 
                                variant='contained' 
                                sx={{...theme.containedBtn, ...theme.btnPx16y4 }}
                                onClick={(e)=> handleCartBtnClick(e, 'inc')}
                            >add to cart</Button>
                        }
