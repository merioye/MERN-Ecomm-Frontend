        ...
        <Box sx={style.container}>
            ...
            {categories.length
                ? categories.map((category) => {
                      return queryOptions.category &&
                          queryOptions.category.includes(category.name) ? (
                          <Chip
                              key={category._id}
                              label={category.name}
            ...
            <Slider
                ...
                value={
                    queryOptions.price
                        ? [
                              Number(queryOptions.price.split("-")[0]),
                              Number(queryOptions.price.split("-")[1]),
                          ]
                        : [productsPriceRange.min, productsPriceRange.max]
                }
                onChange={(e, newValue) => {
                        ...
                        {brands.map((brand) => {
                            return (
                                <FormControlLabel
                                    ...
                                    checked={Boolean(
                                        queryOptions.brand
                                            ? queryOptions.brand.includes(brand)
                                            : false
                                    )}
                                    onChange={(e) =>
                                        redirect(
            ...
            <FormGroup>
                <FormControlLabel
                    control={<Checkbox size="small" />}
                    label={<Typography sx={style.body}>On Sale</Typography>}
                    checked={Boolean(
                        queryOptions.onSale ? queryOptions.onSale : false
                    )}
                    onChange={(e) =>
                        redirect(
                            router,
                ...
                <FormControlLabel
                    control={<Checkbox size="small" />}
                    label={<Typography sx={style.body}>In Stock</Typography>}
                    checked={Boolean(
                        queryOptions.inStock ? queryOptions.inStock : false
                    )}
                    onChange={(e) =>
                        redirect(
                            router,
                ...
                <FormControlLabel
                    control={<Checkbox size="small" />}
                    label={<Typography sx={style.body}>Featured</Typography>}
                    checked={Boolean(
                        queryOptions.isFeatured
                            ? queryOptions.isFeatured
                            : false
                    )}
                    onChange={(e) =>
            ...
            <FormControlLabel
                ...
                checked={Boolean(
                    queryOptions.rating
                        ? queryOptions.rating.includes("5")
                        : false
                )}
                onChange={(e) =>
                    redirect(
            ...
            <FormControlLabel
                ...
                checked={Boolean(
                    queryOptions.rating
                        ? queryOptions.rating.includes("4")
                        : false
                )}
                onChange={(e) =>
                    redirect(
            ...
            <FormControlLabel
                ...
                checked={Boolean(
                    queryOptions.rating
                        ? queryOptions.rating.includes("3")
                        : false
                )}
                onChange={(e) =>
                    redirect(
            ...
            <FormControlLabel
                ...
                checked={Boolean(
                    queryOptions.rating
                        ? queryOptions.rating.includes("2")
                        : false
                )}
                onChange={(e) =>
                    redirect(
            ...
            <FormControlLabel
                ...
                checked={Boolean(
                    queryOptions.rating
                        ? queryOptions.rating.includes("1")
                        : false
                )}
                onChange={(e) =>
                    redirect(
