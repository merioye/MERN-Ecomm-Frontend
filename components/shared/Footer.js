            ...
            >
                <Grid item xs={12} md={6.7} lg={3.5} mr={3}>
                    ...
                    <Typography 
                        ...
                        sx={style.intro}
                    >
                        We started off exclusively as an online fashion retail platform and over the years expanded to become a complete one-stop solution for all your buying needs.
                    </Typography>
                    <Box 
                        display='flex' 
                        flexWrap='wrap'
                ...
                <Grid item xs={12} md={4} lg={2}>
                    <Typography variant='h4' sx={style.heading}>About Us</Typography>
                    <Typography variant='body1' sx={style.link} style={{ paddingTop: '0px' }}>Careers</Typography>
                    <Typography variant='body1' sx={style.link}>Our Stores</Typography>
                    <Typography variant='body1' sx={style.link}>Our Cares</Typography>
                    <Typography variant='body1' sx={style.link}>Terms & Conditions</Typography>
                    <Typography variant='body1' sx={style.link}>Privacy Policy</Typography>
                </Grid>
                <Grid item xs={12} md={7} lg={2.5}>
                    <Typography variant='h4' sx={style.heading}>Customer Care</Typography>
                    <Typography variant='body1' sx={style.link} style={{ paddingTop: '0px' }}>Help Center</Typography>
                    <Typography variant='body1' sx={style.link}>How to Buy</Typography>
                    <Typography variant='body1' sx={style.link}>Track Your Order</Typography>
                    <Typography variant='body1' sx={style.link}>Corporate & Bulk Purchasing</Typography>
                    <Typography variant='body1' sx={style.link}>Returns & Refunds</Typography>
                </Grid>
                <Grid item xs={12} md={4} lg={3}>
                    <Typography variant='h4' sx={style.heading}>Contact Us</Typography>
                    <Typography variant='body1' sx={style.contactText} style={{ paddingTop: '0px' }}>70 Washington Square South, New York, NY 10012, United States</Typography>
                    <Typography variant='body1' sx={style.contactText}>Email: example.help@gmail.com</Typography>
                    <Typography variant='body1' sx={style.contactText}>Phone: +1 1123 456 780</Typography>
