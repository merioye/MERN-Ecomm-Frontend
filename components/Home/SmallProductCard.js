                    ...
                    </Box>
                    {
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <Grid container justifyContent='center'>
                                ...
                                <Grid item>
                                    <Typography variant='body1' sx={style.reviewCount}>({product.reviews.length})</Typography>
                                </Grid>
                            </Grid>
                            <Typography variant='h4' sx={style.heading} style={{ width: '150px'}}>{product.name}</Typography>
                            <Typography variant='h4' sx={style.price}>${product.isOnSale ? product.salePrice : product.regularPrice}</Typography>
                        </Box>
                        :
                        <>
                            <Typography variant='h4' sx={style.heading}>{product.name}</Typography>
                            <Typography variant='h4' sx={style.price}>${product.isOnSale ? product.salePrice : product.regularPrice}</Typography>
                        </>
                    }
                </Box>
