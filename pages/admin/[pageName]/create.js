...
const CreateProduct = ()=>{
    ...
    return(
        <AdminLayout>
            { pageName==='products' && <CreateORUpdateProduct heading='Add New Product'/> }
            { pageName==='categories' && <CreateORUpdateCategoryAndBrand heading='Add New Category'/> }
            { pageName==='brands' && <CreateORUpdateCategoryAndBrand heading='Add New Brand'/> }
            { pageName==='coupons' && <CreateORUpdateCoupon heading='Add New Coupon'/> }
        </AdminLayout>
    )
}
