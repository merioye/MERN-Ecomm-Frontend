...
const Details = ( { data } )=>{
    ...
    return(
        <AdminLayout>
            { pageName==='products' && <CreateORUpdateProduct heading='Edit Product' data={data}/>}
            { pageName==='categories' && <CreateORUpdateCategoryAndBrand heading='Edit Category' data={data}/>}
            { pageName==='brands' && <CreateORUpdateCategoryAndBrand heading='Edit Brand' data={data}/>}
            { pageName==='coupons' && <CreateORUpdateCoupon heading='Edit Coupon' data={data}/>}
            { pageName==='orders' && <OrderDetails/>}
        </AdminLayout>
    )
}
