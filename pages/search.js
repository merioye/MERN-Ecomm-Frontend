...
import { useTheme, Grid, Box, Typography, MenuItem, IconButton } from "@mui/material";
import qs from 'qs';
...
const Search = ( { categories, brands, productsPriceRange, data, totalCount, type } ) => {
    ...
    return (
        <Box sx={style.mainContainer}>
                    ...
                    >
                        ...
                        <Grid item>
                            <Typography
                                variant='body1'
                                sx={style.lightText}
                            >{totalCount===0 ? 'No' : totalCount} results found</Typography>
                        </Grid>
                    </Grid>
                </Grid>
                    ...
                    <Grid item>
                        ...
                        >
                                    ...
                                    <Grid item xs={8.7}>
                                        ...
                                        >
                                            <MenuItem 
                                                ...
                                                value='relevance'
                                                onClick={()=> redirect(router, queryOptions, 'sort', false)}
                                            >Relevance</MenuItem>
                                            <MenuItem 
                                                sx={theme.userSelectMenuItem} 
                                                value='date'
                                                onClick={()=> redirect(router, queryOptions, 'sort', 'date')}
                                            >Date</MenuItem>
                                            <MenuItem 
                                                sx={theme.userSelectMenuItem} 
                                                value='lth'
                                                onClick={()=> redirect(router, queryOptions, 'sort', 'lth')}
                                            >Price Low to High</MenuItem>
                                            <MenuItem 
                                                sx={theme.userSelectMenuItem} 
                                                value='htl'
                                                onClick={()=> redirect(router, queryOptions, 'sort', 'htl')}
                                ...
                                <Grid container>
                                    <Grid item>
                                        <Grid container alignItems='center' gap={1}>
                                            <Grid item>
                                                <Typography variant='body1' sx={style.lightText}>View :</Typography>
                                            </Grid>
                                            <Grid item>
                                                <IconButton onClick={()=> setProductsView('grid')}>
                                                    <AppsIcon sx={productsView==='grid' ? { color: 'pink.dark' } : { color: 'text.primary' }}/>
                                                </IconButton>
                                                <IconButton onClick={()=> setProductsView('list')}>
                                                    <ViewListIcon sx={productsView==='list' ? { color: 'pink.dark' } : { color: 'text.primary' }}/>
                                                </IconButton>
                                            </Grid>
                                        </Grid>
                                    </Grid>
                            ...
                            <Grid 
                                ...
                                >
                                    <Grid item>
                                        <Typography variant='body1' sx={style.lightText}>Filters :</Typography>
                                    </Grid>
                                    <Grid item>
            ...
            {type==='product' && <Filters categories={categories} productsPriceRange={productsPriceRange} brands={brands}/>}
                            ...
                            return <Grid key={product._id} item>
                                {
                                    ...
                                    :
                                    <LandscapeProductCard product={product}/>
                                }
                            </Grid>
                        })
                        :
                        data.map((brand)=>{
                            return  <Grid key={brand._id} item>
